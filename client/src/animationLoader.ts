...
export default class AnimationLoader {
    ...
    public loadAnimations(game: Phaser.Game): Phaser.Sprite {
        ...
        sprite.animations.add(AnimationLoader.ANIM_LEFT_WALK, [18, 19, 20, 21, 22, 23, 24, 25, 26], 10, false)
        sprite.animations.add(AnimationLoader.ANIM_RIGHT_WALK, [54, 55, 56, 57, 58, 59, 60, 61, 62], 10, false)
        return sprite
    }
}